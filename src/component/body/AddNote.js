...
const AddNote = () => {
  ...
  const [AddNoteData, setNote] = useState({ title: "", desc: "", catg: "web development", url: "", catgOther: "" });
    ...
    <div className='container mx-auto mt-4  bg-gray-50 dark:bg-yellow-300 '>
      ...
      <form className="p-1 md:p-5  space-y-1 md:space-y-6" onSubmit={handleformSubmit} >
        <div>
          ...
          <input required type="text" name="title" id="title" value={AddNoteData.title} onChange={onChange} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-secondary-600 focus:border-secondary-500  w-full  p-1 md:p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="xyz" />
        </div>
        <div>
        ...
        <div>
          ...
          <select  hidden={AddNoteData.catg === "other"} value={AddNoteData.catg} onChange={onChange} name="catg" required className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-secondary-600 focus:border-secondary-500 block w-full   p-1 md:p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' >
