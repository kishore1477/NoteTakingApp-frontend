 ...
 <section className="text-gray-600 body-font" style={{userSelect: 'auto'}}>
  <div className="container px-5 py-24 mx-auto" style={{userSelect: 'auto'}}>
    <div className="flex flex-col text-center w-full mb-20" style={{userSelect: 'auto'}}>
      <h2 className="text-xs text-yellow-500 tracking-widest font-medium title-font mb-1" style={{userSelect: 'auto'}}>ROOF PARTY POLAROID</h2>
    ...
    <div className="flex flex-wrap" style={{userSelect: 'auto'}}>
      <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60" style={{userSelect: 'auto'}}>
        ...
        <a className="text-yellow-500 inline-flex items-center" style={{userSelect: 'auto'}}>Learn More
    ...
    <button className="flex mx-auto mt-16 text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg" style={{userSelect: 'auto'}}>Button</button>
  </div>
</section>
