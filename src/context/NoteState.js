...
const showAlert = (type,message)=>{
  ...
  const getUser = async()=>{
    ...
    let resUser = await fetch('https://notetakingappkishore.herokuapp.com/api/auth/loggedUserData', { headers,  method:"POST"})
    ...
    const getNote = async()=>{
      ...
      let res = await fetch('https://notetakingappkishore.herokuapp.com/api/notes/getNote', { headers})
...
const createNote = async(data) =>{
  const res = await fetch('https://notetakingappkishore.herokuapp.com/api/notes/createNote',{  method: 'POST',headers: {
    'Authorization':localStorage.getItem('token'),
...
const Signup  = async(data)=>{
  const res = await fetch('https://notetakingappkishore.herokuapp.com/api/auth/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
const login = async(data) =>{
  const res = await fetch('https://notetakingappkishore.herokuapp.com/api/auth/login',{  method: 'POST',headers: {
    'Content-Type': 'application/json'
  },
  body: JSON.stringify(data)})
  return res
  ...
  // ✔😍 Update 
     ...
     const rawResponse = await fetch(`https://notetakingappkishore.herokuapp.com/api/notes/updateNote/${id}`, {
      method: 'PUT',
      headers: {
...
const handleDelete = async(id)=>{
  ...
  let res = await fetch(`https://notetakingappkishore.herokuapp.com/api/notes/deleteNote/${id}`, { headers, method :"DELETE" })
  if(!res.ok){
